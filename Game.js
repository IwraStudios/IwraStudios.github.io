...
function StartBattle(cPID){
	...
	var graphics1 = new createjs.Graphics().beginFill("#000000").drawRect(10, 267, 225, 40);
	var shape1 = new createjs.Shape(graphics);
	stage.addChild(shape1);
	var graphics2 = new createjs.Graphics().beginFill("#000000").drawRect(300, 267, 225, 50);
